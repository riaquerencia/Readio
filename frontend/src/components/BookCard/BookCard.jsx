...
const headers={
  ...
  const handleRemoveBook= async()=>{
    const response= await axios.put("https://readio-wrte.onrender.com/api/v1/remove-book-from-favourite",{},{headers})
    ...
    <div className='bg-zinc-800 rounded p-4 flex flex-col'>
      <Link to={`/view-book-details/${data._id}`}>
        ...
        <div className="bg-zinc-900 rounded flex items-center justify-center ">
          ...
          <p className="mt-2 text-zinc-400 font-semibold">by {data.author.slice(0,15)}</p>
